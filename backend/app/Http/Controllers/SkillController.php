            ...
            return [
                ...
                'skills' => $categorySkills->map(function ($skill) use ($userSkills) {
                    ...
                    return [
                        ...
                        'current_level' => $userSkill ? (int) $userSkill->pivot->level : 0,
                        'experience' => $userSkill ? (int) $userSkill->pivot->experience : 0,
                        'unlock_cost' => $skill->getUnlockCost(),
                        'upgrade_cost' => $userSkill ? $skill->getUpgradeCost((int) $userSkill->pivot->level) : null,
        ...
        $skills = $user->skills()
            ...
            ->map(function ($skill) {
                return [
                    ...
                    'experience' => (int) $skill->pivot->experience,
                    'max_level' => (int) $skill->max_level,
                    'efficiency_bonus' => (float) $skill->efficiency_bonus,
                    'upgrade_cost' => $skill->getUpgradeCost((int) $skill->pivot->level),
